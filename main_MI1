...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Q-DMDA Blankertz cross-subject EEG classification")
    parser.add_argument("--dataset", type=str, default="seed")
    parser.add_argument("--target", type=int, default=1)
    parser.add_argument("--targets", type=str, default="", help="Comma-separated target subjects. Default: 7,6,5,4,3,2,1")
    parser.add_argument("--num_class", type=int, default=2)
    parser.add_argument("--seed", type=int, default=1)
    parser.add_argument("--seeds", type=str, default="", help="Comma-separated seeds, e.g. 1,2,3,4,5")
    parser.add_argument("--num_source_domains", type=int, default=6)

    parser.add_argument("--feature_path", type=str, default=r"features\Blankertz")
    parser.add_argument("--feature_file_prefix", type=str, default="Blankertz")
    ...
    parser.add_argument("--checkpoint_dir", type=str, default=r"checkpoints\Blankertz_Q-DMDA")
    parser.add_argument("--trial_id", type=str, default="qdmda_blankertz")
    parser.add_argument("--prediction_csv", type=str, default="")
